    ...
    <section id="experiencia" className="py-32 bg-[#0A0A0B] scroll-mt-24">
      <div className="container mx-auto px-6">
        <div className="text-center mb-20">
          <h2 className="text-5xl md:text-7xl font-display font-black mb-6 uppercase tracking-tighter">Experiência e Estudos</h2>
          ...
          {EXPERIENCE_STUDIES.map((item, idx) => (
            ...
            >
              <div className="flex flex-col gap-2">
                <span className="text-[9px] font-display font-black uppercase tracking-[0.3em] text-accent/70 group-hover:text-accent transition-colors">
                  {item.type}
                </span>
                <h3 className="text-xl md:text-2xl font-display font-bold text-white/90 group-hover:text-white transition-colors">
                  {item.title}
                </h3>
