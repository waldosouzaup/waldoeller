    ...
    <section id="tecnologias" className="py-32 bg-[#141416] scroll-mt-24">
      <div className="container mx-auto px-6">
        <div className="text-center mb-20">
          <h2 className="text-5xl md:text-7xl font-display font-black mb-6 uppercase tracking-tighter">Tecnologias</h2>
        ...
        <div className="grid md:grid-cols-3 gap-10">
          {TECH_GROUPS.map((group, idx) => (
            <div key={idx} className="bg-[#0A0A0B]/60 p-10 rounded-[2.5rem] border border-white/5 shadow-xl">
              <h3 className="text-xs font-display font-black mb-10 text-accent/60 uppercase tracking-[0.3em] border-b border-white/5 pb-5">
                {group.title}
              </h3>
