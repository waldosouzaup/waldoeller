...
const AdminDashboard: React.FC<AdminDashboardProps> = ({ onBack }) => {
  ...
  const handleMarkdownArrayChange = (field: string, value: string) => {
    ...
    <section className="min-h-screen bg-[#0A0A0B] pt-20 pb-32 px-6">
      <div className="container mx-auto max-w-6xl">
        <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-16">
          <div>
            <h1 className="text-4xl font-display font-black tracking-tighter uppercase mb-2">Painel <span className="text-accent">Mestre</span></h1>
            <p className="text-white/30 text-[10px] uppercase tracking-[0.4em] font-display font-bold">
        ...
        {editingProject ? (
          <div className="bg-[#141416] w-full rounded-[3rem] border border-white/10 shadow-3xl p-10 md:p-20 animate-fade-in">
            <h2 className="text-3xl font-display font-black uppercase mb-16 text-accent tracking-tighter flex items-center gap-4">
                ...
                <div className="space-y-8">
                  ...
                  <div>
                    ...
                    <textarea 
                      ...
                      rows={4} 
                      className="w-full bg-black/40 border border-white/5 rounded-2xl px-8 py-5 focus:border-accent outline-none text-white text-xs" 
                    />
                  </div>
                  <div>
                    ...
                    <textarea value={editingProject.technologies?.join('\n')} onChange={(e) => handleArrayChange('technologies', e.target.value)} rows={3} className="w-full bg-black/40 border border-white/5 rounded-2xl px-8 py-5 focus:border-accent outline-none text-white text-xs" />
                  </div>
                </div>
              </div>
              ...
              <div className="pt-8 border-t border-white/5">
                ...
                <div className="grid grid-cols-1 gap-12">
                  ...
                  <div className="bg-[#0A0A0B] p-8 rounded-3xl border border-white/5">
                    <h4 className="text-sm font-display font-bold text-white mb-6 uppercase tracking-wider text-accent/80">01. Problema de Negócio</h4>
                  ...
                  <div className="bg-[#0A0A0B] p-8 rounded-3xl border border-white/5">
                    <h4 className="text-sm font-display font-bold text-white mb-6 uppercase tracking-wider text-accent/80">02. Contexto da Solução</h4>
                    <div className="grid lg:grid-cols-2 gap-8">
                      <div>
                  ...
                  <div className="bg-[#0A0A0B] p-8 rounded-3xl border border-white/5">
                    <h4 className="text-sm font-display font-bold text-white mb-6 uppercase tracking-wider text-accent/80">03. Premissas Técnicas</h4>
                    <div className="grid lg:grid-cols-2 gap-8">
                      <div>
                        <label className="block text-[9px] uppercase font-black text-white/20 mb-4 tracking-widest">Lista de Premissas (Separe com duplo Enter)</label>
                        <textarea value={editingProject.premises?.join('\n\n')} onChange={(e) => handleMarkdownArrayChange('premises', e.target.value)} rows={5} className="w-full bg-black/40 border border-white/5 rounded-2xl px-8 py-5 focus:border-accent outline-none text-white font-medium resize-none" />
                      </div>
                      <div>
                        <label className="block text-[9px] uppercase font-black text-white/20 mb-4 tracking-widest">Imagem da Seção (URL)</label>
                  ...
                  <div className="bg-[#0A0A0B] p-8 rounded-3xl border border-white/5">
                    <h4 className="text-sm font-display font-bold text-white mb-6 uppercase tracking-wider text-accent/80">04. Estratégia de Implementação</h4>
                    <div className="grid lg:grid-cols-2 gap-8">
                      <div>
                        <label className="block text-[9px] uppercase font-black text-white/20 mb-4 tracking-widest">Passos da Estratégia (Separe com duplo Enter)</label>
                        <textarea value={editingProject.strategy?.join('\n\n')} onChange={(e) => handleMarkdownArrayChange('strategy', e.target.value)} rows={5} className="w-full bg-black/40 border border-white/5 rounded-2xl px-8 py-5 focus:border-accent outline-none text-white font-medium resize-none" />
                      </div>
                      <div>
                        <label className="block text-[9px] uppercase font-black text-white/20 mb-4 tracking-widest">Imagem da Seção (URL)</label>
                  ...
                  <div className="bg-[#0A0A0B] p-8 rounded-3xl border border-white/5">
                    <h4 className="text-sm font-display font-bold text-white mb-6 uppercase tracking-wider text-accent/80">05. Resultados Obtidos</h4>
                    <div className="grid lg:grid-cols-2 gap-8">
                      <div>
                        <label className="block text-[9px] uppercase font-black text-white/20 mb-4 tracking-widest">Lista de Resultados (Separe com duplo Enter)</label>
                        <textarea value={editingProject.results?.join('\n\n')} onChange={(e) => handleMarkdownArrayChange('results', e.target.value)} rows={5} className="w-full bg-black/40 border border-white/5 rounded-2xl px-8 py-5 focus:border-accent outline-none text-white font-medium resize-none" />
                      </div>
                      <div>
                        <label className="block text-[9px] uppercase font-black text-white/20 mb-4 tracking-widest">Imagem da Seção (URL)</label>
                   ...
                   {/* 06. Próximos Passos */}
                  <div className="bg-[#0A0A0B] p-8 rounded-3xl border border-white/5">
                    <h4 className="text-sm font-display font-bold text-white mb-6 uppercase tracking-wider text-accent/80">06. Próximos Passos</h4>
                    <div className="grid lg:grid-cols-2 gap-8">
                      <div>
                        <label className="block text-[9px] uppercase font-black text-white/20 mb-4 tracking-widest">Lista de Passos Futuros (Separe com duplo Enter)</label>
                        <textarea value={editingProject.next_steps?.join('\n\n')} onChange={(e) => handleMarkdownArrayChange('next_steps', e.target.value)} rows={5} className="w-full bg-black/40 border border-white/5 rounded-2xl px-8 py-5 focus:border-accent outline-none text-white font-medium resize-none" />
                      </div>
                      <div>
                  ...
                  <div className="bg-[#0A0A0B] p-8 rounded-3xl border border-white/5">
                    <h4 className="text-sm font-display font-bold text-white mb-6 uppercase tracking-wider text-accent/80">07. Acesso e Links</h4>
                    <div className="grid lg:grid-cols-2 gap-8">
                      <div>
                  ...
                  {/* 08. Markdown */}
                  <div className="bg-[#0A0A0B] p-8 rounded-3xl border border-white/5">
                    <h4 className="text-sm font-display font-bold text-white mb-6 uppercase tracking-wider text-accent/80">08. Conteúdo Markdown</h4>
                    <div className="grid grid-cols-1 gap-8">
                      <div>
                        <label className="block text-[9px] uppercase font-black text-white/20 mb-4 tracking-widest">Markdown Completo</label>
                        <textarea value={editingProject.markdown} onChange={(e) => setEditingProject({...editingProject, markdown: e.target.value})} rows={15} className="w-full bg-black/40 border border-white/5 rounded-2xl px-8 py-5 focus:border-accent outline-none text-white font-medium resize-none text-sm" placeholder="# Título do Projeto..." />
                      </div>
                    </div>
                  </div>
          ...
          <div className="animate-fade-in">
             <div className="grid md:grid-cols-3 gap-8 mb-16">
                <div className="bg-[#141416] p-10 rounded-[2.5rem] border border-white/5 relative overflow-hidden group">
                  ...
                  <div className="text-6xl font-display font-black text-white tracking-tighter">{stats.projectsCount}</div>
                </div>
                ...
                <div onClick={openNewProjectForm} className="bg-accent p-10 rounded-[2.5rem] text-black shadow-2xl shadow-accent/20 cursor-pointer hover:scale-[1.02] transition-all group relative overflow-hidden">
                  ...
                  <div className="text-2xl font-display font-black uppercase leading-tight relative z-10">Adicionar Novo Projeto +</div>
                </div>
                ...
                <div className="bg-[#141416] p-10 rounded-[2.5rem] border border-white/5 relative overflow-hidden">
                  ...
                  <div className="text-2xl font-display font-black text-green-500 tracking-tighter uppercase flex items-center gap-3 mt-4">
                    ...
                    {projects.map((project) => (
                      <tr key={project.id} className="group hover:bg-white/[0.01] transition-colors">
                        <td className="py-8 px-4 flex items-center gap-5">
                          ...
                          <span className="font-display font-bold text-white/80 group-hover:text-white transition-colors">{project.title}</span>
                        </td>
