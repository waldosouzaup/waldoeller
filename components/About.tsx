        ...
        <div className="grid lg:grid-cols-2 gap-24 items-center">
          <div className="relative">
            ...
            <div className="absolute -bottom-12 -right-12 bg-accent text-black p-12 rounded-[3rem] hidden xl:block shadow-3xl z-20 border-[12px] border-[#0F0F0F]">
              ...
              <span className="text-[12px] font-black uppercase tracking-widest opacity-70">Projetos Ativos</span>
            </div>
          ...
          <div>
            <div className="relative mb-16">
              <span className="text-accent font-black tracking-[0.5em] uppercase text-[12px] block mb-6">Trajetória</span>
              <h2 className="text-6xl md:text-8xl font-black mb-8 tracking-tighter leading-tight">Sobre <span className="text-white/20">Mim</span></h2>
            ...
            <div className="space-y-10">
              <p className="text-2xl md:text-3xl text-white/90 leading-[1.6] font-light italic border-l-4 border-accent pl-10 py-4 text-balance">
                "Transformo complexidade técnica em valor tangível para o negócio através de dados."
              </p>
