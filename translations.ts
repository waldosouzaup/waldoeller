...
export const translations = {
  pt: {
    ...
    hero: {
      ...
      description: 'Transformando complexidade técnica em decisões estratégicas através de projetos analíticos de alto impacto.',
      explore: 'Explorar Portfólio',
      contact: 'Fale Comigo',
      years: 'Anos de',
  ...
  en: {
    ...
    hero: {
      ...
      description: 'Transforming technical complexity into strategic decisions through high-impact analytical projects.',
